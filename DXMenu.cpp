...
HRESULT SetVertexBuffer()
{
	...
	{		
		...
		{ g_width / 2, 0.1 * g_height, 0.0f, 1.0f, 0xFFF00FFF, 0.0f, 0.0f },	//top
		{ g_width, 0.25 * g_height, 0.0f, 1.0f, 0xFFFFFFFF, 1.0f, 0.0f },		//right
		{ 0.0f, 0.25 * g_height, 0.0f, 1.0f, 0xFFFFFFFF, 0.0f, 1.0f },			//left -- 1
		{ g_width / 2, 0.5 * g_height, 0.0f, 1.0f, 0xFFFFFFFF, 1.0f, 1.0f },	//bottom -- 2

		{ 0.1 * g_width, 0.75 * g_height, 0.0f, 1.0f, 0xFFF00FFF, 0.0f, 0.0f },
	};
...
void Render(void)
{
	...
	if (SUCCEEDED(g_pDev->BeginScene()))
	{
		...
		if (mode_index == TITLE) 
		{
			if (title_index == START) 
			{
				TextDraw(g_pFont, "はじめから", 340, 400, 255, 255, 255, 0);
			}
			else 
			{
				TextDraw(g_pFont, "はじめから", 340, 400, 255, 255, 255, 255);
			}

			if (title_index == LOAD) 
			{
				TextDraw(g_pFont, "つづきから", 340, 460, 255, 255, 255, 0);
			}
			else 
			{
				TextDraw(g_pFont, "つづきから", 340, 460, 255, 255, 255, 255);
			}
			if (title_index == OPTION) 
			{
				TextDraw(g_pFont, "設定", 340, 520, 255, 255, 255, 0);
			}
			else 
			{
				TextDraw(g_pFont, "設定", 340, 520, 255, 255, 255, 255);
			}
		}
